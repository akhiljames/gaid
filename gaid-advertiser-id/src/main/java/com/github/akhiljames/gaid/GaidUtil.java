package com.github.akhiljames.gaid;
...
public class GaidUtil {
     ...
     *     Provide it's implementation to {@link com.github.akhiljames.gaid.GaidUtil#getAdInfo(Context, IExecutor, GaidUtil.GaidListener)}
     *</p>
     */
    ...
    protected GaidUtil(GaidListener listener, IExecutor executor){
    ...
    public static void getAdInfo(final Context context, final IExecutor executor,
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                new GaidUtil(gaidListener, executor).getGoogleAdIdInfo(context);
            }
        }).start();
    }
